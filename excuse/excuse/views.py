...
def index(request):
    ...
    return render(request, 'excuse/question_list.html', context)
...
def detail(request, question_id):
    ...
    return render(request, 'excuse/question_detail.html', context)
...
def question_create(request):
    if request.method == 'POST':
        ...
        form = QuestionForm()
    context = {'form': form}
    return render(request, 'excuse/question_form.html', context)
